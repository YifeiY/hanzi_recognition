...
_TPUEMBEDDINGCONFIGURATION_TABLEDESCRIPTOR.fields_by_name['optimization_parameters'].message_type = tensorflow_dot_contrib_dot_tpu_dot_proto_dot_optimization__parameters__pb2._OPTIMIZATIONPARAMETERS
...
_TPUEMBEDDINGCONFIGURATION.fields_by_name['output_layout'].message_type = tensorflow_dot_contrib_dot_tpu_dot_proto_dot_tpu__embedding__output__layout__pb2._TPUEMBEDDINGOUTPUTLAYOUT
...
TPUEmbeddingConfiguration = _reflection.GeneratedProtocolMessageType('TPUEmbeddingConfiguration', (_message.Message,), dict(
  ...
  TableDescriptor = _reflection.GeneratedProtocolMessageType('TableDescriptor', (_message.Message,), dict(
    ...
    __module__ = 'tensorflow.contrib.tpu.proto.tpu_embedding_configuration_pb2'
